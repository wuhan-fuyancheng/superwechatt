...
public class NewGroupActivity extends BaseActivity {
    ...
    @BindView(R.id.iv_new_group_avatar)
    ImageView ivNewGroupAvatar;
    ...
    private void setPicToView(Intent picdata) {
        ...
        if (extras != null) {
            ...
            ivNewGroupAvatar.setImageDrawable(drawable);
...
NetDao.addGroupMembers(this,emGroup,new OkHttpUtils.OnCompleteListener<String>() {
    ...
    private void createGroupSuccess(){
        runOnUiThread(new Runnable() {
            public void run() {
                progressDialog.dismiss();
                CommonUtils.showShortToast(R.string.create_group_success);
                setResult(RESULT_OK);
                finish();
            }
        });
    ...
    @OnClick(R.id.layout_new_group_avatar)
    ...
    public void saveBitmapFile(Intent picdata) {
        ...
        if (extras != null) {
            ...
            String imgpath = EaseImageUtils.getImagePath(System.currentTimeMillis() + I.AVATAR_SUFFIX_JPG);
